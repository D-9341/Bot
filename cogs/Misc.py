...
class Misc(commands.Cog):
    ...
    async def role(self, ctx, *, role: discord.Role):
        ...
        emb.add_field(name = 'Создана', value = role.created_at.strftime("%A, %#d %B %Y, %I:%M %p UTC" * 1000), inline = False)
    ...
    async def about(self, ctx, member: discord.Member = None):
        ...
        emb.add_field(name = 'Создан', value = member.created_at.strftime("%A, %#d %B %Y, %I:%M %p UTC" * 1000), inline = False)
        emb.add_field(name = 'Вошёл', value = member.joined_at.strftime("%A, %#d %B %Y, %I:%M %p UTC" * 1000), inline = False)
