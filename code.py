...
async def help(ctx, amount = 1):
    ...
    emb.add_field(name = '{}give'.format('cephalon/'), value = 'выдаёт роль, писать в формате: give ("выдаваемая роль"(кавычки обязательны)) (пинг пользователя)', inline = False)
    emb.add_field(name = '{}take'.format('cephalon/'), value = 'забирает роль, писать в формате: take ("забираемая роль"(кавычки обязательны)) (пинг пользователя)', inline = False)
