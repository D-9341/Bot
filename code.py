...
client = commands.Bot(prefix = commands.when_mentioned_or('cy/'))
...
async def help(ctx, amount = 1):
    ...
    emb.add_field(name = '{}info'.format(prefix), value = 'Команда для определения, в сети ли бот', inline = False)
    emb.add_field(name = "{}clear".format(prefix), value = 'Очистка чата.')
    emb.add_field(name = "{}ban".format(prefix), value = 'Бан игрока.')
    emb.add_field(name = "{}kick".format(prefix), value = 'Кик игрока.')
    emb.add_field(name = '{}mute'.format(prefix), value = 'Мут игрока.')
    emb.add_field(name = '{}say'.format(prefix), value = 'Пишет сообщение от лица бота. Всё.')
    emb.add_field(name = '{}gaystvo'.format(prefix), value = 'Пишет от лица бота и пингует @everyone')
    emb.add_field(name = '{}embed'.format(prefix), value = 'От лица бота отправляется эмбед. Прочтите #инструкции-cy-бот , чтобы узнать подробнее.')
    emb.add_field(name = '{}gaystvo_embed'.format(prefix), value = 'Совмещает в себе команды gaystvo и embed.')
    emb.add_field(name = '{}image'.format(prefix), value = 'Бот может прикрепить изображение, в аргумент нужно указать ссылку.')
    emb.add_field(name = '{}about'.format(prefix), value = 'Показывает информацию о человеке.')
    emb.add_field(name = '{}guild'.format(prefix), value = 'Показывает информацию о сервере.')
    emb.add_field(name = '{}join'.format(prefix), value = 'Бот заходит в голосовой канал.')
    emb.add_field(name = '{}leave'.format(prefix), value = 'Бот выходит из голосового канала.')
    emb.add_field(name = '{}give'.format(prefix), value = 'Выдаёт роль, писать в формате: give ("выдаваемая роль"(кавычки обязательны для ролей с пробелами)) (пинг пользователя)', inline = False)
    emb.add_field(name = '{}take'.format(prefix), value = 'Забирает роль, писать в формате: take ("забираемая роль"(кавычки обязательны для ролей с пробелами)) (пинг пользователя)', inline = False)
